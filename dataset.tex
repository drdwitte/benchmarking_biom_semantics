...
PubMed, chEMBL, NCBI-Gene, DisGeNET, and EPO are the largest graphs with PubMed already making up 60\% of the data. \todo{biblio?}
...
The query-mix provided by Ontoforce is publicly available \todo{(see Suppl material)}
