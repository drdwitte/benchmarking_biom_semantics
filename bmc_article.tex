...
\begin{figure}[ht!]
	...
	\captionsetup{skip=10pt, font={footnotesize}, labelfont={bf}, width=0.4\textwidth, margin=1cm}
	\caption{\csentence{\todo{NIEUW}Average Runtime per query template for 5 single-node setups.} \textbf{TPF1\_64} has only 5 templates which do not coincide with the timeout of 300s, for \textbf{ES1\_64\_Def} this is already 15 templates.
