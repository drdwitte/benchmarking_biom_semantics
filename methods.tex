...
In this section we describe our benchmark methodology: we define a benchmark space and describe how it was explored, we explain how we made a pre-selection of triple stores, and we list our efforts at making the benchmark more easily reproducible. The last section describes the datasets and queries used in this work. 
