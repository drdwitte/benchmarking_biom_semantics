...
The matrix is online \todo{(see suppl material)}), and end-users can freely download it and/or extend it, change the weights, and update the scores when vendors upgrade their product. 
...
\begin{table}[ht!]
	...
	\begin{tabular}{l|l}
		...
		\hline
		FluidOps~\cite{fluidops} (with FedX 3.1.2~\cite{DBLP:conf/semweb/SchwarteHHSS11})    & \textbf{Flu}     \\
