...
The feature matrix is available online \todo{(see suppl material 1)}), and can be freely downloaded and extended. To back the scoring, we added a layer of trust by linking to the source of information.
...
This led to 4 \emph{Vendor} systems: \todo{Blazegraph,...} 
